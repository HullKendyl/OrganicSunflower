...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Song song9 = new Song ("Drugs", "5:15", "https://www.youtube.com/embed/j_HDCGq4DLg", "https://www.columbusunderground.com/wp-content/uploads/2018/09/t.wong_.jpg", album2 ,artist5);
        Song song10 = new Song("Doubt", "6:32", "https://www.youtube.com/embed/UDPEetr--uE","https://www.columbusunderground.com/wp-content/uploads/2018/09/t.wong_.jpg", album2, artist5);
        Song song11 = new Song("Yellow Submarine","2:46","https://www.youtube.com/embed/m2uTFF_3MaA","https://d2s36jztkuk7aw.cloudfront.net/sites/default/files/styles/media_responsive_widest/public/tile/image/YellowSub.jpg?itok=EMK_FRld&timestamp=1373976663", album4, artist1);
        Song song12 = new Song("Poker Face","3:33","https://www.youtube.com/embed/bESGLojNYSo", "https://upload.wikimedia.org/wikipedia/en/d/dd/Lady_Gaga_%E2%80%93_The_Fame_album_cover.png", album7, artist4);
        Song song13 = new Song("All You Need Is Love","5:54","https://www.youtube.com/embed/_7xMfIp-irg","https://d2s36jztkuk7aw.cloudfront.net/sites/default/files/styles/media_responsive_widest/public/tile/image/YellowSub.jpg?itok=EMK_FRld&timestamp=1373976663", album4, artist1);
        Song song14 = new Song("Just Dance","4:06","https://www.youtube.com/embed/2Abk1jAONjw", "https://upload.wikimedia.org/wikipedia/en/d/dd/Lady_Gaga_%E2%80%93_The_Fame_album_cover.png", album7, artist4);
        Song song15 = new Song("Born This Way","7:19","https://www.youtube.com/embed/wV1FrqwZyKw", "https://upload.wikimedia.org/wikipedia/en/d/dd/Lady_Gaga_%E2%80%93_The_Fame_album_cover.png", album7, artist4);
        Song song16 = new Song("Getting Better","2:48", "https://www.youtube.com/embed/EGlo9LzmOME", "https://upload.wikimedia.org/wikipedia/en/5/50/Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg", album5, artist1);
        Song song17 = new Song("I Want You","7:47","https://www.youtube.com/embed/tAe2Q_LhY8g","https://d2s36jztkuk7aw.cloudfront.net/sites/default/files/tile/image/original_1.jpg", album3, artist1);
        Song song18 = new Song("Strawberry Fields Forever","4:24", "https://www.youtube.com/embed/HtUH9z_Oey8", "https://upload.wikimedia.org/wikipedia/en/5/50/Sgt._Pepper%27s_Lonely_Hearts_Club_Band.jpg", album5, artist1);
